...
const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .geo-ring:nth-child(2) { animation-delay: 0.6s; }
  ...
  .hood-name { font-size: 14px; color: ${T.cream}; font-weight: 400; }
  .hood-dist { font-size: 11px; color: ${T.creamDim}; font-weight: 300; }
...
function StepAccount({ onNext }) {
  ...
  const valid = form.first && form.last && form.email.includes("@") && form.password.length >= 8;
  ...
  return (
    <>
      <div className="th-header">
        ...
        <h1 className="th-step-title">Create your <em>account</em></h1>
        <p className="th-step-sub">Your civic identity — pseudonymous by default, verified by place.</p>
      </div>
      <div className="th-body">
        ...
        <div className="th-field" style={{ animationDelay: "0.1s" }}>
        ...
        <div className="th-field" style={{ animationDelay: "0.15s" }}>
          <label className="th-label">Password <span style={{ color: T.borderHi, fontWeight: 300 }}>— min 8 characters</span></label>
        ...
        <button className="th-btn th-btn-primary" onClick={handleSubmit} disabled={!valid || loading}>
          {loading ? <span style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}><span className="zk-spinner" /> Creating account…</span> : "Continue →"}
        </button>
        <div className="th-terms">By continuing you agree to Townhall's <a>Terms of Use</a> and <a>Privacy Policy</a>.<br />Your address is <strong style={{ color: T.cream }}>never stored</strong>.</div>
      </div>
    </>
  );
}
...
function StepZK({ user, hood, onNext }) {
  ...
  return (
    <>
      ...
      <div className="th-body">
        ...
        <p className="th-terms" style={{ marginTop: 14 }}>This proof uses a commitment scheme. Your device signs a geolocation reading; only the proof — not the coordinates — is transmitted.</p>
      </div>
    </>
  );
}
      ...
      <div className="th-body">
        ...
        <div className="member-card">
          ...
          <div className="member-info">
            ...
            <div className="member-hood"><span>{hood.name} resident</span><span className="member-badge"><div style={{ width: 5, height: 5, borderRadius: "50%", background: T.greenHi }} />ZK verified</span></div>
          </div>
        </div>
