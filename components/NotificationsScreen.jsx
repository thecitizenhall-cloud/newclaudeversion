...
const CITY_ISSUES = [
  { id:1, rank:1, title:"Main St corridor traffic signalling overhaul", hoods:["My Neighborhood","Midtown","Northbank"], totalVoices:847, pct:91, status:"responded", official:{ initials:"RD", name:"Councillor R. Delgado", role:"District 4 · Transport committee" }, response:"The signal timing study has been commissioned and will report by Oct 14. We've allocated emergency interim funding for manual crossing guards at the three highest-risk intersections starting Monday.", respTime:"2h ago" },
  ...
  { id:3, rank:3, title:"City parks lighting — safety infrastructure budget", hoods:["My Neighborhood","Parkside","Southline"], totalVoices:489, pct:64, status:"responded", official:{ initials:"KM", name:"Dir. K. Moore", role:"Parks & Recreation Dept" }, response:"Lighting upgrades have been moved forward to Q2 of next fiscal year pending council approval.", respTime:"Yesterday" },
  { id:4, rank:4, title:"Elm St construction overrun — contractor accountability", hoods:["My Neighborhood","Midtown"], totalVoices:334, pct:51, status:"awaiting", official:null, response:null, respTime:null },
];

const HOODS = [
  { id:"rv", name:"My Neighborhood",  issues:7,  residents:1240, heat:T.amber,  pct:72 },
